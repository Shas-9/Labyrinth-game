...
//     for (const auto& rect : rects) { objects.push_back(new Obj(rect.pos, rect.size)); rect_objects.push_back(new Obj(rect.pos, rect.size)); }
//     for (const auto& circ : circs) { objects.push_back(new Obj(circ.pos, circ.radius)); circ_objects.push_back(new Obj(circ.pos, circ.radius)); }
...
//           if (qt_container_rect.search(AreaCirc(obj->item->getPos(), obj->item->getRadius())).size() > 0) obj->item->setFillColor(sf::Color(255, 255, 255));
//           else obj->item->setFillColor(sf::Color(100, 100, 255));
//           // render
...
//           if (qt_container_circ.search(AreaRect(obj->item->getPos(), obj->item->getDim())).size() > 0) obj->item->setFillColor(sf::Color(255, 255, 255));
//           else obj->item->setFillColor(sf::Color(100, 100, 255));
//           // render
//           obj->item->render(current_camera_pos, zoom);
//         }
